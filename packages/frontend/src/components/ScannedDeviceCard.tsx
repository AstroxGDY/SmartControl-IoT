...
export const ScannedDeviceCard = ({ device, isPairing = false, onAdd }: ScannedDeviceCardProps) => {
    return (
        <div className="bg-slate-900/50 border border-slate-800/80 hover:border-cyan-500/50 hover:bg-slate-900 transition-all p-4 rounded-xl flex items-center justify-between group">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h4 className="font-semibold text-slate-200 group-hover:text-cyan-400 transition-colors line-clamp-1">{device.name}</h4>
