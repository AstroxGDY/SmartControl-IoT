    ...
    <>
      ...
      <div className={`p-5 rounded-[2.5rem] border shadow-sm dark:shadow-none transition-all flex flex-col justify-between h-48 relative
        ...
        <button
          ...
          className="absolute top-3 right-3 p-1.5 rounded-xl bg-white/80 dark:bg-slate-800/80 hover:bg-red-50 dark:hover:bg-red-900/30 text-slate-300 dark:text-slate-400 hover:text-red-500 dark:hover:text-red-400 transition-colors border border-transparent hover:border-red-200 dark:hover:border-red-900/50 shadow-sm dark:shadow-none"
        >
          <Trash2 size={14} />
        </button>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex flex-col min-w-0 pr-8">
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              ...
              <span className="text-[10px] text-slate-500 dark:text-gray-500 font-black uppercase tracking-widest">{statusText}</span>
            </div>
          </div>
        </div>
